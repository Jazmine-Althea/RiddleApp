...
import { level5} from './hangmandata';
...
export default function Level5() {
  ...
  const correctWord = level5[currentIndex].answer;
  ...
  const updateStatus = (cl) => {
    ...
    if (status === 'win' && currentIndex === level5.length-1){
      setStatus('completed')
      return
    }
    setStatus(status);
     ...
     <ImageBackground
      ...
      />
          ...
          <View style={styles.row}>
            ...
            <WordBox wordData={level5[currentIndex]} />
          </View>
