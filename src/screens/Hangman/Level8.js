...
import { level8} from './hangmandata';
...
export default function Level8() {
  ...
  const correctWord = level8[currentIndex].answer;
  ...
  const updateStatus = (cl) => {
    ...
    if (status === 'win' && currentIndex === level8.length-1){
      setStatus('completed')
      return
    }
    setStatus(status);
     ...
     <ImageBackground
      ...
      />
          ...
          <View style={styles.row}>
            ...
            <WordBox wordData={level8[currentIndex]} />
          </View>
