...
import { level3} from './hangmandata';
...
export default function Level3() {
  ...
  const correctWord = level3[currentIndex].answer;
  ...
  const updateStatus = (cl) => {
    ...
    if (status === 'win' && currentIndex === level3.length-1){
      setStatus('completed')
      return
    }
    setStatus(status);
     ...
     <ImageBackground
      ...
      />
          ...
          <View style={styles.row}>
            ...
            <WordBox wordData={level3[currentIndex]} />
          </View>
