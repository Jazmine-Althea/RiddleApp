...
import { level4} from './hangmandata';
...
export default function Level4() {
  ...
  const correctWord = level4[currentIndex].answer;
  ...
  const updateStatus = (cl) => {
    ...
    if (status === 'win' && currentIndex === level4.length-1){
      setStatus('completed')
      return
    }
    setStatus(status);
     ...
     <ImageBackground
      ...
      />
          ...
          <View style={styles.row}>
            ...
            <WordBox wordData={level4[currentIndex]} />
          </View>
