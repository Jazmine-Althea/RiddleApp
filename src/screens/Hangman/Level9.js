...
import { level9} from './hangmandata';
...
export default function Level9() {
  ...
  const correctWord = level9[currentIndex].answer;
  ...
  const updateStatus = (cl) => {
    ...
    if (status === 'win' && currentIndex === level9.length-1){
      setStatus('completed')
      return
    }
    setStatus(status);
     ...
     <ImageBackground
      ...
      />
          ...
          <View style={styles.row}>
            ...
            <WordBox wordData={level9[currentIndex]} />
          </View>
