...
import {View, Text, Image, StyleSheet, ImageBackground, TouchableOpacity, Modal, Animated} from 'react-native';
import { COLORS, ROUTES, IMGS } from '../../constants';
import {EasyModeData} from './Data';

export default function Easy({ navigation }) {
  
  const allQuestions = EasyModeData;
